...
import { applyViolations, handleNext } from '@/presentation/contact/mvvm/view-models/contact2-input-handler';
import { Action, setValue, State } from '@/presentation/contact/mvvm/view-models/contact2-reducer';
