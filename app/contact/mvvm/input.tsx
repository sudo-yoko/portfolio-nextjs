...
import { applyViolations, handleNext } from '@/modules/contact/mvvm/view-models/contact2-input-handler';
import { Action, setValue, State } from '@/modules/contact/mvvm/view-models/contact2-reducer';
